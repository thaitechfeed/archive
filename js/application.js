...
//
  var templates = {
    ...
    user_nav: Hogan.compile('<a href="#" class="icon-sprite icon-user dropdown-toggle" data-toggle="dropdown"></a><ul class="dropdown-menu"><li><a href="#user-info" data-toggle="modal"><i class="icon-user"></i>ดูรายละเอียดของบัญชี</a></li><li class="divider"></li><li><a href="https://twitter.com/{{screen_name}}" target="_blank"><i class="icon-share-alt"></i>ดูหน้าโปรไฟล์บนทวิตเตอร์</a></li></ul>'),
    modal_header: Hogan.compile('<h3> รายละเอียดบัญชี <span class="download-date muted">ณ {{created_at_relative}}</span></h3>'),
    ...
    modal_payload_details: Hogan.compile('<p>{{tweets}} <span class="footer-label muted">ทวีต</span></p>'),
    modal_account_details: Hogan.compile('<p>#{{id}} <span class="footer-label muted">เลขที่ผู้ใช้</span></p><p class="truncated">{{created_at_relative}} <span class="footer-label muted">วันที่เข้าร่วม</span></p>'),
    ...
    singular_tweet_count: Hogan.compile('{{count}} ทวีต'),
    plural_tweet_count: Hogan.compile('{{count}} ทวีต')
  };
//
  ...
  exports.init = function () {
    ...
    .bind('invalidSearch', function (e) {
      e.preventDefault();
      $(this)
        .attr('data-original-title', 'คําค้นหาของคุณต้องมีความยาวอย่างน้อยสองตัวอักษร')
        .tooltip('show');
    });
  ...
  (function(exports) {
    exports.base = {
      init: function () {
        $('.navbar-search .search-query').attr('placeholder', 'ค้นหาทวีตทั้งหมด');
  ...
  (function(exports) {
    var Tweets = function () {
      this.str_singular       = 'ทวีต';
      this.str_plural         = 'ทวีต';
  ...
  (function (exports){
    ...
    exports.localizeStrings = function() {
      ...
      document.title = "คลังทวิตเตอร์ของคุณ";
      $('#footer-text').append("นี่คือคลังทวีตแบบออฟไลน์ของคุณจากทวิตเตอร์ เลือกเดือนข้างบนเพื่อดูคลังทวีต");
      var compose_new_tweet = "เขียนทวีตใหม่";
